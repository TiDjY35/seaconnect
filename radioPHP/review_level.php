...
<html>
    <head>
        <title>Arduino Water Level Log</title>
        <style type="text/css">
    ...
    <body>
        ...
        <table border="0" cellspacing="0" cellpadding="4">
            ...
            $result = mysql_query("SELECT * FROM radio.waterlevel WHERE date > DATE_SUB(NOW(), INTERVAL 24 HOUR)");
